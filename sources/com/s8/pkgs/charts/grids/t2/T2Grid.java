 ...
 *
 */
public class T2Grid extends S8WebObject {

	
	
	private List<T2GridCard> cards = new ArrayList<>();
	 ...
	 * @param front
	 */
	public T2Grid(S8WebFront front) {
		super(front, WebSources.WEBPATH + "/grids/t2/T2Grid");
	...
	public void setCards(List<T2GridCard> cards) {
		this.cards = cards;
	 ...
	 * @return
	 */
	public List<T2GridCard> getCards(){
		return cards;
	}


	public void unselectAllCards() {
		List<T2GridCard> cards = getCards();
		if(cards != null) {
			cards.forEach(card -> {
				card.clearPopover();
