...
import { T1GridCard } from './T1GridCard.js';
 ...
 * 
 */
S8WebFront.CSS_import('/S8-pkgs-charts/grids/t1/T1Grid.css');

export class T1Grid extends S8Object {
    ...
    constructor(){
        ...
        this.wrapperNode.classList.add("t1grid-wrapper");

        this.coreNode = document.createElement("div");
        this.coreNode.classList.add("t1grid-core");
        ...
        this.upToDateOverlayNode.classList.add("t1grid-overlay");
